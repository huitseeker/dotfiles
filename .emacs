  ...
  (use-package racer
    ...
    (progn
      ...
      (unless (getenv "RUST_SRC_PATH")
        (setenv "RUST_SRC_PATH" (shell-command-to-string "echo `rustc --print sysroot`/lib/rustlib/src/rust/src/")))
      (setq racer-cmd "~/.cargo/bin/racer")
      (setq racer-rust-src-path (shell-command-to-string "echo `rustc --print sysroot`/lib/rustlib/src/rust/src/"))
